<header class="flex justify-between items-center py-4 px-6 bg-white border-b-2 border-indigo-600">
    ...
    <div class="flex items-center">
        <div x-data="{ notificationOpen: false }" class="relative">
            ...
            <div x-show="notificationOpen"
                class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg overflow-hidden z-10"
        ...
        <div class="font-bold text-indigo-500 mr-1">
            {{ Auth::user()->name }}
        </div>
